...
void I2cMcuFormat( I2c_t *obj, I2cMode mode, I2cDutyCycle dutyCycle, bool I2cAckEnable, I2cAckAddrMode AckAddrMode, uint32_t I2cFrequency )
{
	...
	//I2C_DUTY_CYCLE_16_9
	I2C_InitStructure.I2C_DutyCycle = ( dutyCycle == I2C_DUTY_CYCLE_2 ) ? 0xBFFF : 0x4000;
	I2C_InitStructure.I2C_Ack = ( I2cAckEnable == true ) ? 0x0400 : 0x0000;
	 // I2C_ACK_ADD_10_BIT
	I2C_InitStructure.I2C_AcknowledgedAddress = ( AckAddrMode == I2C_ACK_ADD_7_BIT ) ? 0x4000 : 0xC000;
	I2C_InitStructure.I2C_ClockSpeed = ( I2cFrequency > 400000 ) ? 400000 : I2cFrequency;
